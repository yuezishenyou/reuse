...
//    [IQKeyboardManager sharedManager].enable = YES;//是不是启用
//    [IQKeyboardManager sharedManager].shouldResignOnTouchOutside = YES;//点击背景关闭
//    [IQKeyboardManager sharedManager].enableAutoToolbar = NO;//键盘上的工具条
